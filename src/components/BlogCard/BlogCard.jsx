            ...
            <div className='shadow rounded-lg group'>
                ...
                <div className='py-8 px-4'>
                    <div className='flex items-center gap-8'>
                        ...
                        <span className='flex items-center gap-2'><BsCalendar2Date style={dateIcon} />21 August,2023</span>
                    </div>
                    <h2 className='text-textBlue fnt font-bold text-lg py-4 group-hover:text-my-pink'>Top esssential Trends in 2023</h2>
